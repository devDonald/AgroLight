...
public class FarmersEditModel {
    ...
    public FarmersEditModel() {

    }

    public FarmersEditModel(Double longitude, Double latitude) {
        this.longitude = longitude;
        this.latitude = latitude;
    }

    public FarmersEditModel(String names, String gender, String age, String lga, String state,
