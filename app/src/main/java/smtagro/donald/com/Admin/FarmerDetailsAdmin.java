...
import smtagro.donald.com.EditFarmersDetails;
import smtagro.donald.com.R;
import smtagro.donald.com.models.FarmersModel;

public class FarmerDetailsAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer_details_admin);
            ...
            if (position!=null){
                ...
                ValueEventListener valueEventListener = new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Picasso.with(FarmerDetailsAdmin.this).load(profile_image).into(mfarmerImage);
                        Picasso.with(FarmerDetailsAdmin.this).load(id_image).into(mIdImage);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.edit_farmer_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_edit_farmer) {
            Intent edit = new Intent(FarmerDetailsAdmin.this, EditFarmersDetails.class);
