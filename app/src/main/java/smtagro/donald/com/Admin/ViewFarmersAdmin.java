...
public class ViewFarmersAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_farmers_admin);

        viewFarmersRecycler = findViewById(R.id.view_farmer_admin_recycler);
            ...
            public ViewFarmerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                viewHolder.setOnClickListener(new ViewFarmerHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent wholeProfile=new Intent(ViewFarmersAdmin.this, FarmerDetailsAdmin.class);
